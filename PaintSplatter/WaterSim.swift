...
public class WatercolorSimulation {
    ...
    public func paint(texture: MTLTexture) {
        ...
        if state.getState() == .Preparing {
            ...
            var wet = Float(WaterSimConstants.splatWetness)
